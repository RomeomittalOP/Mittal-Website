...
export const metadata: Metadata = {
  ...
  title: {
    default: "Website Development Agency in India — MITTAL.WEBSITE | From ₹5,555",
    template: "%s | MITTAL.WEBSITE",
  },
  description:
    "Want to get a website made? MITTAL.WEBSITE is a premium web development agency building business websites, landing pages & web apps that convert. Starting from ₹5,555 — free consultation, delivered in 10 days.",
  keywords: [
    "website banwani hai",
